...
const I18N = {
  ...
  en: {
    ...
    metodoClasifP: (n) => `The ${n} tweets were classified with Gemini 3.7 Flash. Party names are normalized to PSOE, PP, Vox and Sumar before calculating counts and filters.`,
